...
export default function Websites(props) {
  ...
  return (
    <Grid container direction="column">
      ...
      >
        <Grid item>
          <Grid container direction="column">
            ...
            <Grid item>
              <img src={ecommerce} alt="world outline made of a dollar signs" />
            </Grid>
          </Grid>
        </Grid>
        <Grid
      ...
      {/**E-commerce Block End */}
      {/**Outreach Block Start */}
      ...
      {/**SEO Block End */}
      {/**CallToAction Block Start */}
      <CallToAction setValue={props.setValue} />
      {/**CallToAction Block End */}
    </Grid>
  );
}
